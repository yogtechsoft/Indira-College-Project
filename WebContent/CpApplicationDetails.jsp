		...
		<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-success">
						<div class="panel-heading">CPP Department Application Details</div>
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover" id="getSupplierValue">
									...
									<%
										ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tbl_cp_department_application_received_details");
									while (rs.next()) {
									%>
									<tbody>
										<tr>
