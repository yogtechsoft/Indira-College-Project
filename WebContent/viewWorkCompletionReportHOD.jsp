...
<form role="form" action="updateApplicationWorkCompletionReport" method="post">
							...
							<select class="form-control" id="srNo" name="srNo">
								<option>Select</option>
									<%
									 ...
									 ResultSet contractorName = DatabaseConnection.getResultFromSqlQuery("SELECT id,institute_name FROM `tbl_work_completion_approved_admin_details` WHERE institute_id="+instId+" and role_id="+roleId+"");
	...
	$("#srNo").change(function(){
		$.ajax({
			url : 'fetchWorkCompletionReportforHOD',
			data : {
				srNo:$("#srNo").val()
			},
			success : function(responseText) { 
