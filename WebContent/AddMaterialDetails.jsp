...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
				<div class="col-md-12">
					<h4 class="header-line">Add Material Details <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add Supplier</button>
					</h4>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
	        <form role="form" action=saveMaterialSupplierDetails method="post">
	        
	         <div class="row">
	       			<div class="col-md-4">
							<div class="form-group">
								<label>Enter Supplier Name</label> 
								<input class="form-control" type="text" name="supplierName" id="supplierName" placeholder="Enter Supplier Name" required="required"/>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="materialName" id="materialName" placeholder="Enter Material Name" required="required" />
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control" name="supplierName" id="supplierName" required="required">
							<option>Select</option> 
				<%
				int index12 = 0;
				ResultSet supplierName = DatabaseConnection.getResultFromSqlQuery("select * from tblsuppliermaterialdetails");
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control" name="materialName" id="materialName" required="required">
							<option>Select</option> 
							<%
				int index13 = 0;	
				ResultSet materialName = DatabaseConnection.getResultFromSqlQuery("select * from tblsuppliermaterialdetails");
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="transportCharge" id="transportCharge" placeholder="Enter Transport Charges" required="required" />
					</div>
				</div>
		...
		<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-success">
						<div class="panel-heading">Supplier Details History</div>
										...
										<div class="form-group">
												<label>Select Supplier Name</label> 
													<select class="form-control" name="supplierNameRecord" id="supplierNameRecord">
														...
														<%
									int index14 = 0;	
									ResultSet fetchSupplierName = DatabaseConnection.getResultFromSqlQuery("select  distinct(supplierName) from  tblmaterialdetails");
									while (fetchSupplierName.next()) {
										index14++;
									%>
									<option value="<%=fetchSupplierName.getString(1)%>"><%=fetchSupplierName.getString(1)%></option> 
									<%
											}
										%>
													</select>
