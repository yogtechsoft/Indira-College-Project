...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
				<div class="col-md-12">
					<h4 class="header-line">View Work Completion Report
					</h4>
...
<form role="form" action="updateApplicationWorkCompletionReport" method="post">
							...
							<select class="form-control" id="srNo" name="srNo">
								<option>Select</option>
									<%
									 ...
									 Integer instaCorporate=(Integer) session.getAttribute("institute");

									 ResultSet contractorName = DatabaseConnection.getResultFromSqlQuery("SELECT id,institute_name FROM `tbl_work_completion_report_project_department` WHERE institute_id="+instaCorporate+" and role_id="+roleId+"");
	...
	$("#srNo").change(function(){
		$.ajax({
			url : 'fetchWorkCompletionReportforAdmin',
			data : {
				srNo:$("#srNo").val()
			},
			success : function(responseText) { 
