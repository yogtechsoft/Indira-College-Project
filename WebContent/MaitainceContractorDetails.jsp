...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
				<div class="col-md-12">
					<h4 class="header-line">Maintance Contractor Register &nbsp <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Add Contractor</button>
					</h4>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
	        <form role="form" action=SaveMaintainceContractorName method="post">
	       			...
	       			<div class="col-md-4">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="mobileNocontractor" id="mobileNocontractor" placeholder="Enter Mobile No" required="required" />
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="addressContractor" id="addressContractor" placeholder="Enter Mobile No" required="required" />
							</div>
						</div>
...
<form role="form" action=SaveMaintainceWorkDetails method="post">
	...
	<div class="row">
		...
		<br><br>		
			...
			<div class="row">
				...
				<%
				int ip = 0;
				ResultSet contractorName = DatabaseConnection.getResultFromSqlQuery("SELECT id,contractorName FROM tblmaintancecontractorname");
				...
				<div class="col-md-3">
					<div class="form-group">
						<label>Address</label> 
						 <input class="form-control" type="text" name="address" id="address" placeholder="Enter Address" required="required" />
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						<label>Campus</label> 
						<select class="form-control" type="text" name="campusName" id="campusName"  required="required">
							<option value="0">Select</option>
							<option value="0">Computer / IT</option>
							<option value="1">EXTC</option>
							<option value="2">Mechnical</option>
						</select>
					</div>
				</div>
	...
	function fetchContractorBasicDetails(){
		$.ajax({
			url : 'FetchContractorNameDetails',
			data : {
			...
			success : function(responseText) {
				...
				$("#mobileNo").val(dataTablesObj[0].mobileNo);
				$("#address").val(dataTablesObj[0].address);
