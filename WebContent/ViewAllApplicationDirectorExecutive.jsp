						...
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover" id="getSupplierValue">
									...
									<%
										ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tbl_project_manging_director_executive_application_save_details");
									while (rs.next()) {
									%>
									<tbody>
										<tr>
											...
											<td><%=rs.getString("dirctor_remark")%></td>
