...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
				<div class="col-md-12">
					<h4 class="header-line">Register User Details 
					</h4>
...
<form role="form" action=SaveUserRegisteration method="post">
			...
			<div class="col-md-3">
					<div class="form-group">
						<label>First Name</label> 
						 <input class="form-control" type="text" name="firstName" id="firstName" placeholder="Enter First Name" required="required" />
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label>Middle Name</label> 
						 <input class="form-control" type="text" name="midleName" id="midleName" placeholder="Enter Middle Name" required="required" />
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label>Last Name</label> 
						 <input class="form-control" type="text" name="lastName" id="lastName" placeholder="Enter Last Name" required="required" />
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label>Date Of Birth</label> 
						 <input class="form-control" type="date" name="dateOfBirth" id="dateOfBirth" placeholder="Enter Date Of Birth" required="required" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					...
					<%
					int ip = 0;
					ResultSet contractorName = DatabaseConnection.getResultFromSqlQuery("SELECT id,institue_name FROM `mst_institute_name` WHERE is_Active='Y'");
				...
				<div class="col-md-3">
					...
					<select class="form-control" id="roleMaster" name="roleMaster">
					<option>Select</option>
					<%
					int rp = 0;
					ResultSet roleName = DatabaseConnection.getResultFromSqlQuery("SELECT id,role_name FROM `mst_role_master`");
					while (roleName.next()) {
						rp++;
					%>
						<option value="<%=roleName.getString(1)%>"><%=roleName.getString(2)%></option> 
						<%
							}
						%>
					</select>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="workExperience" id="workExperience" placeholder="Enter Work Expereience" />
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="emailId" id="emailId" placeholder="Enter Email Id" />
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="pinCode" id="pinCode" placeholder="Enter Pincode" />
					</div>
				</div>
