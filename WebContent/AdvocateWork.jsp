...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
				<div class="col-md-12">
					<h4 class="header-line">Advocate Documnent Information
					</h4>
				
</div>
<form role="form" action="saveLegealDocument" method="post" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="form-group">
				...
				<input class="form-control" id="agreement" type="file" name="agreement" required="required">
			</div>
		</div>	
		<div class="col-md-3">
			<div class="form-group">
				<label>NOC</label> 
				<input class="form-control" id="noc" type="file" name="noc"  required="required">
			</div>
		</div>		
		<div class="col-md-3">
			<div class="form-group">
				<label>Notice</label> 
				<input class="form-control" id="notice" type="file" name="notice"  required="required">
			</div>
		</div>
