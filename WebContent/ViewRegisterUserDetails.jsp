		...
		<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-success">
						<div class="panel-heading">User Register Details</div>
								...
								<table class="table table-striped table-bordered table-hover" id="getSupplierValue">
									...
									<%
									 Integer userId = (Integer) session.getAttribute("userId");	
										...
										ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from  tbl_user_register_details");
									while (rs.next()) {
									%>
									<tbody>
										<tr>
											...
											<td><%=rs.getString("insitiute_name")%></td>
