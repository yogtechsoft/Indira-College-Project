		  		...
		  		<div class="row" id="budgetYear">
						<div class="col-md-3">
							<div class="form-group">
								...
								<input class="form-control"type="text" name="budgetYearDetails" id="budgetYearDetails" />
					...
					<div class="row" id="balanceProposed">
						<div class="col-md-3">
							<div class="form-group">
								...
								<input class="form-control" type="text"
									name="balanceProposedDetails" id="balanceProposedDetails" required="required" placeholder="Enter Balance After Proposed Expenses"/>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input class="form-control" type="text"
									name="budgetType" id="budgetType" required="required" placeholder="Enter Expenses Till Date" />
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
	...
	$("#srNo").change(function(){
		$.ajax({
			...
			success : function(responseText) { 
				...
				$("#budgetYearDetails").val(dataTablesObj[0].budgetYear);
				$("#balanceProvision").val(dataTablesObj[0].balanceProvision);
				$("#provisionAmount").val(dataTablesObj[0].balanceProvisionAmount);
				$("#expensesAmount").val(dataTablesObj[0].proposedExpesnseAmount);
				$("#balanceProposedDetails").val(dataTablesObj[0].balanceAfterProposedAmount);
				$("#expensesTillDate").val(dataTablesObj[0].expensesTilDate);
				$("#budgetType").val(dataTablesObj[0].budgetType);
				...
				$("#budgetYearDetails").prop('readonly',true);
				$("#balanceProvision").prop('readonly',true);
				$("#provisionAmount").prop('readonly',true);
				$("#expensesAmount").prop('readonly',true);
				$("#balanceProposedDetails").prop('readonly',true);
				$("#expensesTillDate").prop('readonly',true);
				$("#budgetType").prop('readonly',true);
				var srrNo=$("#srNo").val();
