...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
				<div class="col-md-12">
					<h4 class="header-line">Update Maintaince Construction Details
					</h4>
...
/*  window.onchange = function() { 
			...
			$.ajax({
				...
				success : function(responseText) {
					...
					for(var i=0;i<=dataTablesObj.length-1;i++){
						...
						$("#contractorWork").append("<option value='"+dataTablesObj[i].maintainceConstructionWorkName+"'>"+dataTablesObj[i].maintainceConstructionWorkName+"</option>");
					}
	...
	function fetchDetailsForInspection(){
		...
		$.ajax({
			url : 'fetchMaintainceWorkInspection',
			data : {
				customerName : $('#customerName').val(),
				contractorWork: $("#contractorWork").val()
				},
			success : function(responseText) {
				...
				for(var i=0;i<=dataTablesObj.length-1;i++){
					...
					$("#campusName").val(dataTablesObj[i].mainainceCampus);
					$("#building").val(dataTablesObj[i].maintainceBuilding);
					$("#floor").val(dataTablesObj[i].maintainceFloor);
