...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
				<div class="col-md-12">
					<h4 class="header-line">View PO Report Purchase Department
					</h4>
						...
						<label>Select Sr.No</label> 
							<select class="form-control" id="srNo" name="srNo">
								<option>Select</option>
									...
									ResultSet contractorName = DatabaseConnection.getResultFromSqlQuery("SELECT id,institute_name FROM `tbl_create_po_report` WHERE role_id="+roleId+" and status='"+status+"'");
		  	...
		  	<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-success">
						<div class="panel-heading">View PO Report</div>
