...
<form role="form" action=SaveIndentDetailsProjectDepartment method="POST">
						...
						<label>Select Institute Name</label> 
							<select class="form-control" id="InstituteName" name="InstituteName" required>
								<option value="">Select</option>
									<%
										int ip = 0;
										ResultSet contractorName = DatabaseConnection.getResultFromSqlQuery("SELECT id,institue_name FROM `mst_institute_name`");
