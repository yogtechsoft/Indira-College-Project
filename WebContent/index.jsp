...
<body>
	...
	<div class="header-bot">
		<div class="container">
			<div class="col-md-3 header-left">
				<h1>
					<a href="index-2.html"><img src="images/logo12.jpg"></a>
				</h1>
			</div>
			<div class="col-md-6 header-middle">
				<form action="searchProduct.jsp" method="post">
					<div class="search">
						<input type="search"  name="search" placeholder="Search Details" style="width: 680px;">
					</div>
					<div class="sear-sub">
		...
		<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="images/const1.jpg"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/const2.jpg"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/const3.jpg"
						alt="Dummy Image" /></li>
				</ul>
				...
				<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ba11.jpg"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ba12.jpg"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ba13.jpg"
									alt="Dummy Image" />
							</div></li>
					</ul>
	...
	<div class="header">
		<div class="container">
			<ul>
				<li><span class="glyphicon glyphicon-time" aria-hidden="true"></span>Believe Construction Quality</li>
				<li><span class="glyphicon glyphicon-shopping-cart"
					aria-hidden="true"></span>Trust on Construction Work</li>
