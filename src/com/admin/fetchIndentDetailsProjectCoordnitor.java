...
@WebServlet("/fetchIndentDetailsProjectCoordnitor")
public class fetchIndentDetailsProjectCoordnitor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_project_cordniator_application_received_details` where id="+srNO);
