...
@WebServlet("/SaveIndentDetailsProjectDepartment")
public class SaveIndentDetailsProjectDepartment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (addCustomer > 0) {
				...
				response.sendRedirect("CreateIntendProject.jsp");
			} else {
				String message="fail";
				hs.setAttribute("message", message);
				response.sendRedirect("CreateIntendProject.jsp");
