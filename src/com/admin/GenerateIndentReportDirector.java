...
@WebServlet("/GenerateIndentReportDirector")
public class GenerateIndentReportDirector extends HttpServlet  {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_save_project_dept_application` WHERE id="+customerId);
