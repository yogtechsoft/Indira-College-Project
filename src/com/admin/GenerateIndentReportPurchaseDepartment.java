...
@WebServlet("/GenerateIndentReportPurchaseDepartment")
public class GenerateIndentReportPurchaseDepartment extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_purchase_department_application_received_details` WHERE id="+customerId);
          ...
          //for invoice Generated
			...
			//File file = new File("/home/jarandes/upload/Indent Report_"+customerName+".pdf"); //for PROD
