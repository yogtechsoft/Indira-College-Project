...
@WebServlet("/GenerateIndentReportAccountDepartment")
public class GenerateIndentReportAccountDepartment extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM ` tbl_account_department_application_received_details` WHERE id="+customerId);
