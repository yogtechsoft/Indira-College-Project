...
@WebServlet("/GenerateIndentReportCPPDepartment")
public class GenerateIndentReportCPPDepartment extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_cp_department_application_received_details` WHERE id="+customerId);
