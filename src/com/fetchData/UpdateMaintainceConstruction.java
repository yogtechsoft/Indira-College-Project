	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(update == 1) {
				...
				int i = DatabaseConnection.insertUpdateFromSqlQuery("insert into tblmaintaincesiteinspect(siteWorkDetails,campus,building,floor,startDate,endDate,dailyTaskDetails,contractorId,todayDate,modifiedBy) "
