...
@WebServlet("/fetchTrackingIndentStatus")
public class fetchTrackingIndentStatus extends  HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while (captchResultSet.next()) {
				...
				st.setPending_status(captchResultSet.getString("tracking_status"));
