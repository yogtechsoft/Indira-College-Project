...
@WebServlet("/DirectorDownloadDetails")
public class DirectorDownloadDetails extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT name,file_data FROM `tbl_director_department_application_received_dewtails` where id="+fileId);
