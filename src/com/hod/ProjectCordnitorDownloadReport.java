...
@WebServlet("/ProjectCordnitorDownloadReport")
public class ProjectCordnitorDownloadReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT name,file_data FROM `tbl_project_cordniator_application_received_details` where id="+fileId);

			if (captchResultSet.next()) {
				String fileName = captchResultSet.getString("name");
