...
@WebServlet("/DownloadPhotoInspection")
public class DownloadPhotoInspection extends HttpServlet {
	 ...
	 @Override
	    protected void doGet(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try {
				...
				ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT file_name,file_data FROM `tblsiteinspectiondetails` where contractorId="+fileId+ " and siteWorkDetails='"+contractorWork+"' and id="+id);
