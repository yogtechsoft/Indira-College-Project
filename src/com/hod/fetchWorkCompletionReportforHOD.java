...
@WebServlet("/fetchWorkCompletionReportforHOD")
public class fetchWorkCompletionReportforHOD extends  HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_work_completion_approved_admin_details` where id="+srNO);
