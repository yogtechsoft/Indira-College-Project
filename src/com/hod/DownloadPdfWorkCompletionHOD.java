...
@WebServlet("/DownloadPdfWorkCompletionHOD")
public class DownloadPdfWorkCompletionHOD extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT filename,file_data FROM `tbl_work_completion_approved_admin_details` where id="+fileId);
