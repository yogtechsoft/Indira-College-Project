...
@WebServlet("/DownloadPdfProjectExcutive")
public class DownloadPdfProjectExcutive extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT filename,filedata FROM `tbl_project_director_excutor_application_details` where id="+fileId);
