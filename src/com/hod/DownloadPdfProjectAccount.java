...
@WebServlet("/DownloadPdfProjectAccount")
public class DownloadPdfProjectAccount  extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT filename,filedata FROM `tbl_account_department_application_received_details` where id="+fileId);
