	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int addCustomer = DatabaseConnection.insertUpdateFromSqlQuery(
					...
					+ "values('" + instituteName+ "','" + indenterName + "','" + department + "','" + date + "','" + discription + "','" + materialRequired + "','"+ quantity + "','" + reasonWork + "','" + specificAgency + "','" + indentValue + "','" + deliveryRequired + "','"+ workCompletion + "','" + previousRef +"','"+ remark +"','"+status+"',"+userId+","+role+","+asad+",'"+app+"','"+hodApprovedDate+"','"+imageName+"','"+imagePath+"')");
			if (addCustomer > 0) {
