...
@WebServlet("/DownloadPdfCPPDepartment")
public class DownloadPdfCPPDepartment extends HttpServlet{
	@Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT filename,filedata FROM `tbl_cp_department_application_received_details` where id="+fileId);
