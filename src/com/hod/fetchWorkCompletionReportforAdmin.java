...
@WebServlet("/fetchWorkCompletionReportforAdmin")
public class fetchWorkCompletionReportforAdmin extends  HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_work_completion_report_project_department` where id="+srNO);
