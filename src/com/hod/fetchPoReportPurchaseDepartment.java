...
@WebServlet("/fetchPoReportPurchaseDepartment")
public class fetchPoReportPurchaseDepartment extends  HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_create_po_report` where id="+srNO);
