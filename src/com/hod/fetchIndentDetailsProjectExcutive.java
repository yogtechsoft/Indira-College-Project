...
@WebServlet("/fetchIndentDetailsProjectExcutive")
public class fetchIndentDetailsProjectExcutive extends  HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM `tbl_project_director_excutor_application_details` where id="+srNO);
