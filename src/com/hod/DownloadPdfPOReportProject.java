...
@WebServlet("/DownloadPdfPOReportProject")
public class DownloadPdfPOReportProject extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			ResultSet captchResultSet = DatabaseConnection.getResultFromSqlQuery("SELECT name,file_data FROM `tbl_create_po_report` where id="+fileId);
